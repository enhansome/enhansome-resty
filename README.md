...
* OpenResty Package Manager (`opm`): [package repository](https://opm.openresty.org/), [opm sources](https://github.com/openresty/opm) ⭐ 486 | 🐛 31 | 🌐 Lua | 📅 2026-08-13

## How to Contribute on this List?

There are at least three different ways to contribute:

1. [Create a New Issue](https://github.com/bungle/awesome-resty/issues/new) ⭐ 2,485 | 🐛 2 | 📅 2026-05-26 where you describe the needed additions, deletions or changes.
2. [Fork this repository](https://github.com/bungle/awesome-resty/fork) ⭐ 2,485 | 🐛 2 | 📅 2026-05-26 and make the changes, and create a pull request.
...
* [ngx\_openresty](https://github.com/openresty/openresty) ⭐ 14,030 | 🐛 335 | 🌐 C | 📅 2026-09-02 — Turning Nginx into a full-fledged Web App Server - Sources for OpenResty Bundle Generation
* [lua-nginx-module](https://github.com/openresty/lua-nginx-module) ⭐ 11,787 | 🐛 395 | 🌐 C | 📅 2026-09-07 — Embed the power of Lua into Nginx
* [headers-more-nginx-module](https://github.com/openresty/headers-more-nginx-module) ⭐ 1,783 | 🐛 52 | 🌐 C | 📅 2026-08-24 — Set and clear input and output headers...more than "add"!
...
* [stream-lua-nginx-module](https://github.com/openresty/stream-lua-nginx-module) ⭐ 750 | 🐛 50 | 🌐 C | 📅 2026-09-12 — Embed the power of Lua into Nginx stream/TCP Servers
...
* [array-var-nginx-module](https://github.com/openresty/array-var-nginx-module) ⭐ 68 | 🐛 2 | 🌐 C | 📅 2026-08-24 — Add support for array variables to nginx config files
...
Please also note that there is **`resty`** command line client included in OpenResty bundle. The [command line client sources](https://github.com/openresty/resty-cli) ⭐ 269 | 🐛 11 | 🌐 Perl | 📅 2026-08-24 can be found on Github.
...
* [nchan](https://nchan.io/) ([Github](https://github.com/slact/nchan) ⭐ 3,065 | 🐛 134 | 🌐 C | 📅 2026-09-11) — Fast, horizontally scalable, multiprocess pub/sub queuing server and proxy for HTTP, long-polling, Websockets and EventSource (SSE)
...
* [lua-resty-core](https://github.com/openresty/lua-resty-core) ⭐ 853 | 🐛 71 | 🌐 Lua | 📅 2026-08-24 — New FFI-based Lua API for the ngx\_lua module
...
* [lua-resty-websocket](https://github.com/openresty/lua-resty-websocket) ⭐ 523 | 🐛 32 | 🌐 Lua | 📅 2026-08-24 — Lua WebSocket implementation for the ngx\_lua module
...
* [lua-resty-lrucache](https://github.com/openresty/lua-resty-lrucache) ⭐ 461 | 🐛 15 | 🌐 Lua | 📅 2026-07-17 — Lua-land LRU Cache based on LuaJIT FFI
...
* [lua-resty-shell](https://github.com/openresty/lua-resty-shell) ⭐ 133 | 🐛 7 | 🌐 Raku | 📅 2026-08-24 — Lua module for nonblocking system shell command executions
* [lua-tablepool](https://github.com/openresty/lua-tablepool) ⭐ 122 | 🐛 1 | 🌐 Raku | 📅 2026-08-24 — Lua table recycling pools for LuaJIT
...
* [lua-resty-signal](https://github.com/openresty/lua-resty-signal) ⭐ 34 | 🐛 2 | 🌐 Raku | 📅 2026-08-24 — Lua library for killing or sending signals to Linux processes
...
* [lua-resty-session](https://github.com/bungle/lua-resty-session) ⭐ 343 | 🐛 28 | 🌐 Lua | 📅 2026-08-24 — Session library for OpenResty implementing Secure Cookie Protocol
...
* [neturl](https://github.com/golgote/neturl) ⭐ 261 | 🐛 8 | 🌐 Lua | 📅 2024-12-07 — URL and Query string parser, builder, normalizer for Lua
* [lua-resty-woothee](https://github.com/woothee/lua-resty-woothee) ⭐ 66 | 🐛 0 | 🌐 Lua | 📅 2021-10-13 — The Lua-Openresty implementation of Project Woothee, which is a multi-language user-agent strings parsers
...
* [lua-resty-jwt-verification](https://github.com/anvouk/lua-resty-jwt-verification) ⭐ 16 | 🐛 0 | 🌐 Lua | 📅 2026-06-27 — JWT verification library for OpenResty with JWKS integration
...
* [lua-resty-libr3](https://github.com/iresty/lua-resty-libr3) ⭐ 56 | 🐛 8 | 🌐 Perl | 📅 2021-06-21 — High-performance path dispatching library base on [libr3](https://github.com/c9s/r3) ⭐ 820 | 🐛 29 | 🌐 C | 📅 2026-09-01 for OpenResty
* [lua-resty-r3](https://github.com/toritori0318/lua-resty-r3) ⭐ 39 | 🐛 0 | 🌐 Lua | 📅 2015-12-23 — [libr3](https://github.com/c9s/r3) ⭐ 820 | 🐛 29 | 🌐 C | 📅 2026-09-01 OpenResty implementation, libr3 is a high-performance path dispatching library. It compiles your route paths into a prefix tree (trie). By using the constructed prefix trie in the start-up time, you may dispatch your routes with efficiency

#### Traffic Management

* [lua-resty-redis-ratelimit](https://github.com/timebug/lua-resty-redis-ratelimit) ⭐ 170 | 🐛 2 | 🌐 Perl | 📅 2026-06-01 — Limit the request processing rate between multiple NGINX instances backed by Redis
* [lua-resty-limit-rate](https://github.com/upyun/lua-resty-limit-rate) ⭐ 72 | 🐛 0 | 🌐 Perl | 📅 2021-06-11 - Lua module for limiting request rate for OpenResty/ngx\_lua, using the "token bucket" method
...
* [Kong](https://getkong.org/) ([GitHub](https://github.com/Kong/kong) ⭐ 44,126 | 🐛 200 | 🌐 Lua | 📅 2026-09-07) — KONG: Microservice Management Layer (Secure, Manage & Extend your APIs and Microservices)
* [APISIX](https://github.com/iresty/apisix) ⭐ 17,113 | 🐛 234 | 🌐 Lua | 📅 2026-09-11 — APISIX is a Cloud-Native Microservices API Gateway
...
* [lua-resty-validation](https://github.com/bungle/lua-resty-validation) ⭐ 154 | 🐛 2 | 🌐 Lua | 📅 2021-08-31 — An extendable chaining validation and filtering library for Lua and OpenResty
...
* [lua-resty-xxhash](https://github.com/bungle/lua-resty-xxhash) ⭐ 17 | 🐛 1 | 🌐 Lua | 📅 2015-12-03 — LuaJIT FFI-bindings to xxHash, an Extremely fast non-cryptographic hash algorithm
...
* [lua-resty-limit-traffic](https://github.com/openresty/lua-resty-limit-traffic) ⭐ 854 | 🐛 38 | 🌐 Lua | 📅 2026-08-24 — Lua library for limiting and controlling traffic in OpenResty/ngx\_lua
* [lua-resty-websocket](https://github.com/openresty/lua-resty-websocket) ⭐ 523 | 🐛 32 | 🌐 Lua | 📅 2026-08-24 — Lua WebSocket implementation for the ngx\_lua module
...
* [lua-resty-memcached](https://github.com/openresty/lua-resty-memcached) ⭐ 216 | 🐛 8 | 🌐 Lua | 📅 2026-08-24 — Lua memcached client driver for the ngx\_lua based on the cosocket API
* [lua-resty-etcd](https://github.com/api7/lua-resty-etcd) ⭐ 203 | 🐛 21 | 🌐 Lua | 📅 2026-08-17 — Nonblocking Lua etcd driver library for OpenResty
...
* [lua-resty-tarantool](https://github.com/perusio/lua-resty-tarantool) ⭐ 47 | 🐛 4 | 🌐 Lua | 📅 2025-02-27 — Library for working with Tarantool from Nginx with the embedded Lua module or with OpeRresty
...
* [lua-shdict-nginx-module](https://github.com/rainingmaster/lua-shdict-nginx-module) ⭐ 18 | 🐛 0 | 🌐 Perl | 📅 2018-05-25 — An upgraded version of [ngx.shared.DICT](https://github.com/openresty/lua-nginx-module#ngxshareddict) ⭐ 11,787 | 🐛 395 | 🌐 C | 📅 2026-09-07, capable of sharing data between `stream` and `http` modules
...
* [FlameGraph](https://github.com/brendangregg/FlameGraph) ⭐ 19,745 | 🐛 173 | 🌐 Perl | 📅 2024-10-20 — Flame graphs are a visualization of profiled software, allowing the most frequent code-paths to be identified quickly and accurately
* [Test::Nginx](http://search.cpan.org/~agent/Test-Nginx-0.24/lib/Test/Nginx.pm) — Data-driven test scaffold for Nginx C module and OpenResty Lua library development (see real-word tests in [lua-resty-redis](https://github.com/openresty/lua-resty-redis/tree/master/t) ⭐ 1,956 | 🐛 75 | 🌐 Lua | 📅 2026-08-24)
...
* [busted](http://olivinelabs.com/busted/) ([Github](https://github.com/Olivine-Labs/busted) ⭐ 1,636 | 🐛 64 | 🌐 Lua | 📅 2026-08-25) — Elegant Lua unit testing
...
* [Inspect](https://github.com/kikito/inspect.lua) ⭐ 1,538 | 🐛 7 | 🌐 Lua | 📅 2026-01-05 — Inspect is a library that transforms any Lua value into a human-readable representation. It is especially useful for debugging errors in tables.
* [lua-resty-radixtree](https://github.com/api7/lua-resty-radixtree) ⭐ 283 | 🐛 21 | 🌐 C | 📅 2024-11-28 — Lua / OpenResty implementation based on FFI for [rax](https://github.com/antirez/rax) ⭐ 1,269 | 🐛 25 | 🌐 C | 📅 2023-11-26
...
* [lua-resty-base-encoding](https://github.com/spacewander/lua-resty-base-encoding) ⭐ 19 | 🐛 0 | 🌐 C | 📅 2021-08-05 — Provides base32/base16/... encoding for OpenResty applications.
...
These libraries are not build to using `lua-nginx-module`s date time functions (except luatz) like [`ngx.today`](https://github.com/openresty/lua-nginx-module#ngxtoday) ⭐ 11,787 | 🐛 395 | 🌐 C | 📅 2026-09-07, [`ngx.time`](https://github.com/openresty/lua-nginx-module#ngxtime) ⭐ 11,787 | 🐛 395 | 🌐 C | 📅 2026-09-07, [`ngx.now`](https://github.com/openresty/lua-nginx-module#ngxnow) ⭐ 11,787 | 🐛 395 | 🌐 C | 📅 2026-09-07, [`ngx.localtime`](https://github.com/openresty/lua-nginx-module#ngxlocaltime) ⭐ 11,787 | 🐛 395 | 🌐 C | 📅 2026-09-07, or [`ngx.utctime`](https://github.com/openresty/lua-nginx-module#ngxutctime) ⭐ 11,787 | 🐛 395 | 🌐 C | 📅 2026-09-07, but they may still come handy. At some point we may need a more "official" time library for OpenResty.

* [LuaDate](https://github.com/Tieske/date) ⭐ 277 | 🐛 1 | 🌐 Lua | 📅 2026-02-17 — Lua Date and Time module for Lua 5.x
...
* [lua-resty-zip](https://github.com/doujiang24/lua-resty-zip) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2019-08-12 — ZIP functions(compress/uncompress) for LuaJIT
...
* [Lua Fun](https://github.com/rtsisyk/luafun) ⭐ 2,262 | 🐛 46 | 🌐 Lua | 📅 2026-09-10 — Lua Fun is a high-performance functional programming library for Lua designed with LuaJIT's trace compiler in mind
* [Penlight](https://github.com/stevedonovan/Penlight) ⭐ 2,127 | 🐛 44 | 🌐 Lua | 📅 2026-09-03 — Penlight brings together a set of generally useful pure Lua modules, focusing on input data handling (such as reading configuration files), functional programming (such as map, reduce, placeholder expressions, etc), and OS path management
...
* [Nginx-Lua-Anti-DDoS](https://github.com/C0nw0nk/Nginx-Lua-Anti-DDoS) ⭐ 1,637 | 🐛 0 | 🌐 Lua | 📅 2026-09-12) — A Anti-DDoS script to protect Nginx web servers using Lua with a Javascript based authentication puzzle inspired by Cloudflare
...
* [OpenResty Best Practices](https://github.com/moonbingbing/openresty-best-practices) ⭐ 3,606 | 🐛 38 | 🌐 Lua | 📅 2024-06-13 ([GitBook](https://www.gitbook.com/book/moonbingbing/openresty-best-practices/details)) (Chinese, use e.g. Google Translate)
...
* [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,570 | 🐛 50 | 📅 2024-08-11 by [@LewisJEllis](https://github.com/LewisJEllis)
* [A collection of resources covering Nginx, Nginx + Lua, OpenResty and Tengine](https://github.com/fcambus/nginx-resources) ⭐ 3,810 | 🐛 0 | 📅 2026-08-04
